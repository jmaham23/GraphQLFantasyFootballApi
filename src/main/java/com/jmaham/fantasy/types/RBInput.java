...
public class RBInput {
  ...
  public RBInput(Integer rank, String name, String team, Integer rushAtt, Integer rushYds,
  ...
  public String toString() {
    return "RBInput{" + "rank='" + rank + "'," +"name='" + name + "'," +"team='" + team + "'," +"rushAtt='" + rushAtt + "'," +"rushYds='" + rushYds + "'," +"yA='" + yA + "'," +"lg='" + lg + "'," +"rushTds='" + rushTds + "'," +"rec='" + rec + "'," +"tgt='" + tgt + "'," +"recYds='" + recYds + "'," +"yR='" + yR + "'," +"recTds='" + recTds + "'," +"fl='" + fl + "'," +"games='" + games + "'," +"fPts='" + fPts + "'," +"fPtsAGame='" + fPtsAGame + "'," +"rostPct='" + rostPct + "'," +"year='" + year + "'" +"}";
  }
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(rank, name, team, rushAtt, rushYds, yA, lg, rushTds, rec, tgt, recYds, yR, recTds, fl, games, fPts, fPtsAGame, rostPct, year);
  }

  public static com.jmaham.fantasy.types.RBInput.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public RBInput build() {
                  com.jmaham.fantasy.types.RBInput result = new com.jmaham.fantasy.types.RBInput();
    ...
    public com.jmaham.fantasy.types.RBInput.Builder rank(Integer rank) {
      this.rank = rank;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder name(String name) {
      this.name = name;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder team(String team) {
      this.team = team;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder rushAtt(Integer rushAtt) {
      this.rushAtt = rushAtt;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder rushYds(Integer rushYds) {
      this.rushYds = rushYds;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder yA(Double yA) {
      this.yA = yA;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder lg(Integer lg) {
      this.lg = lg;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder rushTds(Integer rushTds) {
      this.rushTds = rushTds;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder rec(Integer rec) {
      this.rec = rec;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder tgt(Integer tgt) {
      this.tgt = tgt;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder recYds(Integer recYds) {
      this.recYds = recYds;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder yR(Double yR) {
      this.yR = yR;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder recTds(Integer recTds) {
      this.recTds = recTds;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder fl(Integer fl) {
      this.fl = fl;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder games(Integer games) {
      this.games = games;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder fPts(double fPts) {
      this.fPts = fPts;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder fPtsAGame(double fPtsAGame) {
      this.fPtsAGame = fPtsAGame;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder rostPct(Double rostPct) {
      this.rostPct = rostPct;
      return this;
    }

    public com.jmaham.fantasy.types.RBInput.Builder year(int year) {
      this.year = year;
      return this;
    }
  }
