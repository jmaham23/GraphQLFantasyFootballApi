...
public class K {
  @Id
  @SequenceGenerator(name = "k_sequence", sequenceName = "k_sequence", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "k_sequence")
  private String id;
  ...
  public K(String id, Integer rank, String name, String team, Integer fg, Integer fga, Double pct,
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, rank, name, team, fg, fga, pct, lg, oneToNineteen, twentyToTwentynine, thirtyToThirtynine, fortyToFortynine, fiftyPlus, xpt, xpa, games, fPts, fPtsAGame, rostPct, year);
  }

  public static com.jmaham.fantasy.types.K.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public K build() {
                  com.jmaham.fantasy.types.K result = new com.jmaham.fantasy.types.K();
                      result.id = this.id;
    ...
    public com.jmaham.fantasy.types.K.Builder id(String id) {
      this.id = id;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder rank(Integer rank) {
      this.rank = rank;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder name(String name) {
      this.name = name;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder team(String team) {
      this.team = team;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fg(Integer fg) {
      this.fg = fg;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fga(Integer fga) {
      this.fga = fga;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder pct(Double pct) {
      this.pct = pct;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder lg(Integer lg) {
      this.lg = lg;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder oneToNineteen(Integer oneToNineteen) {
      this.oneToNineteen = oneToNineteen;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder twentyToTwentynine(Integer twentyToTwentynine) {
      this.twentyToTwentynine = twentyToTwentynine;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder thirtyToThirtynine(Integer thirtyToThirtynine) {
      this.thirtyToThirtynine = thirtyToThirtynine;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fortyToFortynine(Integer fortyToFortynine) {
      this.fortyToFortynine = fortyToFortynine;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fiftyPlus(Integer fiftyPlus) {
      this.fiftyPlus = fiftyPlus;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder xpt(Integer xpt) {
      this.xpt = xpt;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder xpa(Integer xpa) {
      this.xpa = xpa;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder games(Integer games) {
      this.games = games;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fPts(int fPts) {
      this.fPts = fPts;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder fPtsAGame(double fPtsAGame) {
      this.fPtsAGame = fPtsAGame;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder rostPct(Double rostPct) {
      this.rostPct = rostPct;
      return this;
    }

    public com.jmaham.fantasy.types.K.Builder year(int year) {
      this.year = year;
      return this;
    }
  }
